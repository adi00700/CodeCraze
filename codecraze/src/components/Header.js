    ...
    <header>
      <div className="header-container">
        <div className="header-left">
          <Link to="/">
            <img
              src="https://www.bing.com/images/create/logo-for-code-craze-that-looks-like-a-maze/64aea66dd87c4d48ab4eabe8a8bbdd5d?id=TpI2YGuRCenMU41fRFELrQ%3d%3d&view=detailv2&idpp=genimg&idpclose=1&FORM=SYDBIC"
              alt="logo"
            />
          </Link>
          {/* <a href="/">
